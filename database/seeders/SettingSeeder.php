...
class SettingSeeder extends Seeder
{
    public function run()
    {
        ...
        \DB::table('expense_types')->insert([
            [ 'id'=>'1', 'expense_name'=>'Office Rent', ],
            [ 'id'=>'2', 'expense_name'=>'Utility Bill', ],
            [ 'id'=>'3', 'expense_name'=>'Entertainment (Office)', ],
            [ 'id'=>'4', 'expense_name'=>'Conveyance Bill', ],
            [ 'id'=>'5', 'expense_name'=>'Entertainment (Guest)', ],
            [ 'id'=>'6', 'expense_name'=>'Advertising & Promotion', ],
            [ 'id'=>'7', 'expense_name'=>'Printing & Stationery', ],
            [ 'id'=>'8', 'expense_name'=>'IT Equipments', ],
            [ 'id'=>'9', 'expense_name'=>'Miscellaneous', ],
            [ 'id'=>'10', 'expense_name'=>'Sales Promotion', ],
            [ 'id'=>'11', 'expense_name'=>'Transport Cost', ],
            [ 'id'=>'12', 'expense_name'=>'Salaries and wages', ],
            [ 'id'=>'13', 'expense_name'=>'Bonus', ],
            [ 'id'=>'14', 'expense_name'=>'Office Furniture', ],
            [ 'id'=>'15', 'expense_name'=>'Insurance', ],
            [ 'id'=>'16', 'expense_name'=>'Maintenance and Repairs', ],
            [ 'id'=>'17', 'expense_name'=>'Office Supplies', ],
            [ 'id'=>'18', 'expense_name'=>'Tax Expenses', ],
            [ 'id'=>'19', 'expense_name'=>'VAT Expenses', ],
            [ 'id'=>'20', 'expense_name'=>'Fee & Professional', ],
            [ 'id'=>'21', 'expense_name'=>'C&F Bill', ],
            [ 'id'=>'22', 'expense_name'=>'Travel Expenses', ],
            [ 'id'=>'23', 'expense_name'=>'IT Maintenance', ],
            [ 'id'=>'24', 'expense_name'=>'Car repair & Maintenance', ],
            [ 'id'=>'25', 'expense_name'=>'Office Equipment', ],
            ]);
