...
Route::get('/vatTransaction', '\App\Http\Controllers\InvoiceController@vatTransaction')->name('vatTransaction');
...
Route::get('/performance_details', '\App\Http\Controllers\ReportController@performance_details')->name('performance_details');
...
Route::get('/sbalance_report', '\App\Http\Controllers\BalanceReportController@sbalance_report')->name('sbalance_report');
