                ...
                <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel"
                    ...
                    <div class="portlet-body form portrait" id="print_this0">
                                ...
                                <td style="text-align:center; border: none" width="35%">
                                    <div class="company-address"
                                        ...
                                        <H3 style="font-weight: bold; margin: 0; padding: 0;"
                                            class="company-name">{{$settings->org_name}}</H3>
                                        <span class="company-address"> {{$settings->address_line1.' '.$settings->address_line2}}</span><br/>
                                        <span class="company-address">{{$settings->contact_no1}}</span><br/>
                                        <span class="company-address">{{$settings->email}}</span><br/>
                                        <span class="company-address">{{$settings->web}}</span>
                                    </div>
                        ...
                        <table class="table-hover center" width="60%" style="table-layout: fixed; ">
                            ...
                            <tr >
                                <td colspan="2" style="height: 40px; border: none">Customer Signature</td>
                                <td colspan="4" style="border: none">Authorised Signature</td>
                            </tr>
                            <tr style="border: none">
