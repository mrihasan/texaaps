...
@section('breadcrumb')
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">{{ __('all_settings.Update Return') }}</a>
    </li>
@endsection
@push('css')
...
@section('maincontent')
    ...
    <div class="card card-success card-tabs">
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">{{ __('all_settings.Update Return') }}</a>
                </li>
                <li class="nav-item">
                    <a href="{{ url('returnTransaction') }}" class="nav-link">
                        {{ __('all_settings.Manage Return') }}
                    </a>
                </li>
        ...
        <div class="form-body">
            {{ csrf_field() }}
            {!! Form::hidden('transaction_type', 'Return' )!!}
