        ...
        <div class="card-body">
            <div class="tab-content" id="custom-tabs-one-tabContent">
                <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel"
                    ...
                    <table class="table dataTables table-striped table-bordered table-hover" id="purchase-table">
                        <thead>
                    ...
                    <div class="row justify-content-center">
                        <div class="card card-info col-md-8">
                            <div class="card-body">
                                ...
                                {!! Form::open(array('method' => 'get', 'url' => 'purchaseTransaction','class'=>'form-horizontal')) !!}
...
<script>
    $(document).ready(function () {
        ...
        var table = $('#purchase-table').DataTable({
            ...
            ajax: {
                url: './purchaseTransaction',
                type: 'GET',
                data: {
//                    start_date: $("#StartDate").val(moment().subtract(30, 'days').format('YYYY-MM-DD')),
//                    end_date: $("#EndDate").val(moment(endDate).format('YYYY-MM-DD')) },

        start_date: '2024-11-1 00:00:00', end_date: '2024-11-31 00:00:00' },
                },
                ...
                columns: [
                    ...
                    {data: 'transaction_code', defaultContent: "-"},
                    {data: 'transaction_type', defaultContent: "-"},
                    {data: 'user_id', defaultContent: "-"},
                    {data: 'branch_id', defaultContent: "-"},
                    {data: 'product_total', defaultContent: "-"},
                    {data: 'total_amount', defaultContent: "-"},
                    {data: 'invoice_total', defaultContent: "-"},
                    {data: 'action'},
                ],
...
//                    orientation : 'landscape',
                        ...
                        customize: function (doc) {
                            ...
                            doc.content[1].table.widths = ['5%', '13%', '12%', '13%', '12%', '10%', '7%', '20%', '8%'];
