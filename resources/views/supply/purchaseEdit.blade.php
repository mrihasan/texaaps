...
@section('breadcrumb')
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">{{ __('all_settings.Update Purchase') }}</a>
    </li>
@endsection
@push('css')
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">{{ __('all_settings.Update Purchase') }}</a>
                </li>
                <li class="nav-item">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group row {{ $errors->has('supplier_id') ? ' has-error' : '' }}">
                            <label class="control-label col-md-12 text-left">Select Supplier :<span
                                        class="required"> * </span></label>
                            <div class="col-md-12">
                                {{ Form::select('supplier_id', $supplier,$invoice->user_id, ['class'=>'form-control select2bs4 ', 'required'] ) }}
                    ...
                    <div class="col-md-3">
                        <div class="form-group row {{ $errors->has('reference') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                {!! Form::number('reference', $invoice->reference,['class'=>'form-control ', 'placeholder'=>'Enter Reference']) !!}
