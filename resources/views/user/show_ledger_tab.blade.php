        ...
        <table class="table dataTables table-striped table-bordered table-hover " >
            ...
            @foreach($ledger as $key=>$data)
                <tr>
                    ...
                    {{--                                        <td>{{$data['transaction_type'][$key]}}</td>--}}
                    <td style="text-align: right">{{($data['transaction_type'][$key]=='Credited'||$data['transaction_type'][$key]=='Receipt'||$data['transaction_type'][$key]=='Purchase'||$data['transaction_type'][$key]=='Return'||$data['transaction_type'][$key]=='Payslip')?$data['transaction_amount'][$key]:''}}</td>
                    <td style="text-align: right">{{($data['transaction_type'][$key]=='Debited'||$data['transaction_type'][$key]=='Sales'||$data['transaction_type'][$key]=='Payment'||$data['transaction_type'][$key]=='Put Back')?$data['transaction_amount'][$key]:''}}</td>
