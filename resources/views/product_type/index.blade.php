...
@section('breadcrumb')
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Manage Product Type</a>
    </li>
@endsection
@push('css')
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">Product Type </a>
                </li>
                @can('ProductMgtAccess')
                    <li class="nav-item">
                        <a href="{{ url('product_type/create') }}" class="nav-link">
                            Add Product Type
                        </a>
                    </li>
                @endcan
                    ...
                    <table class="table dataTables table-striped table-bordered table-hover">
                        ...
                        @foreach($product_types as $key => $product_type)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('product_type/' . $product_type->id ) }}" class="btn btn-success btn-xs"
