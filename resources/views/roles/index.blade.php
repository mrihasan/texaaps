...
@section('breadcrumb')
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Manage Role</a>
    </li>
@endsection
@push('css')
                ...
                <tbody>
                    @foreach($roles as $key => $role)
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('role/' . $role->id) }}" class="btn btn-success btn-xs" title="View"><span class="far fa-eye" aria-hidden="true"></span></a>
                                {{--@can('role-edit')--}}
                                    <a href="{{ url('role/' . $role->id . '/edit') }}" class="btn btn-info btn-xs" title="Edit"><span class="far fa-edit" aria-hidden="true"></span></a>
                                {{--@endcan--}}
                                {{--@can('role-delete')--}}
                                        {!! Form::open([
                                            'method'=>'DELETE',
