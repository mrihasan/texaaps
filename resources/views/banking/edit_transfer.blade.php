...
@section('breadcrumb')
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Transfer Update</a>
    </li>
@endsection
@push('css')
        ...
        <div class="card card-info col-md-8">
            ...
            <div class="card-body">
                <div class="form-group row{{ $errors->has('withdraw_account') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        {{ Form::select('withdraw_account', $accounts, $bank_ledger->bank_account_id,['class'=>'form-control select2'] ) }}
                    </div>
                ...
                <div class="form-group row {{ $errors->has('withdraw_method') ? ' has-error' : '' }}">
                    <label class="col-sm-4 control-label text-md-right">Withdraw Method : <span
                                class="required"> * </span></label>
                    <div class="col-sm-6">
                        {{ Form::select('withdraw_method', $transaction_methods, $bank_ledger->transaction_method_id,['class'=>'form-control select2'] ) }}
                ...
                <div class="form-group row{{ $errors->has('deposit_account') ? 'has-error' : '' }}">
                    <label for="roles" class="col-md-4 control-label text-right">Deposit to Account :<span
                                class="required"> * </span></label>
                    <div class="col-md-6">
                        {{ Form::select('deposit_account', $accounts, $deposit_ledger->bank_account_id,['class'=>'form-control select2'] ) }}
                    </div>
                ...
                <div class="form-group row {{ $errors->has('deposit_method') ? ' has-error' : '' }}">
                    <label class="col-sm-4 control-label text-md-right">Deposit Method : <span
                                class="required"> * </span></label>
                    <div class="col-sm-6">
                        {{ Form::select('deposit_method', $transaction_methods, $deposit_ledger->transaction_method_id,['class'=>'form-control select2'] ) }}
                ...
                <div class="form-group row {{ $errors->has('transaction_date') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6 input-group date" id="transaction_date"
                        ...
                        <input type="text" class="form-control datetimepicker-input"
                               ...
                               value="{{Carbon\Carbon::parse(date('Y-m-d ', strtotime($deposit_ledger->transaction_date)))->format('dd-mm-YYYY')}}" data-target="#transaction_date"/>
                ...
                <div class="form-group row {{ $errors->has('ref_no') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        {!! Form::text('ref_no', null,['class'=>'form-control ', 'placeholder'=>'Enter ref_no']) !!}
