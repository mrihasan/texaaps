        ...
        <div class="card card-info col-md-8">
            ...
            <div class="card-body">
                ...
                <div class="form-group row {{ $errors->has('account_name') ? ' has-error' : '' }}">
                    <label class="col-md-4 control-label text-md-right">Account Title :<span
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <select name="account_type" class="form-control" id="account_type" required>
                            ...
                            <option value="Loan Account" {{ (isset($banking) && $banking->account_type == 'Loan Account') ? ' selected' : '' }}>Loan Account</option>
                        </select>
                    </div>
                </div>
                <div class="form-group row">
