...
@section('breadcrumb')
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Manage Branch Ledger</a>
    </li>
@endsection
                ...
                <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel"
                    ...
                    <table class="table dataTables table-striped table-bordered table-hover " >
                        ...
                        @foreach($ledger as $key=>$data)
                            <tr>
                                <td>{{Carbon\Carbon::parse($data->transaction_date)->format('d-M-Y, h:ia') }}</td>
                                ...
                                <td>
                                    <a href="{{ url('bank_ledger/'.$data->transaction_code) }}" class="btn btn-success btn-xs" title="View "><span class="far fa-eye" aria-hidden="true"></span></a>

                                    @can('AccountMgtAccess')
                                        <a href="{{ url('bank_ledger/' . $data->transaction_code . '/edit') }}"
                                    ...
                                    @can('AccountMgtDelete')
                                        {!! Form::open([
                                            'method'=>'DELETE',
                                            'url' => ['bank_ledger', $data->transaction_code],
