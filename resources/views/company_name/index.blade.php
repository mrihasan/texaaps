...
@section('breadcrumb')
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Manage Company</a>
    </li>
@endsection
@push('css')
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                ...
                <li class="nav-item">
                    @can('ProductMgtAccess')
                        <a href="{{ url('company_name/create') }}" class="nav-link">
                            Add Company
                        </a>
                    @endcan
                    ...
                    <table class="table dataTables table-striped table-bordered table-hover">
                        ...
                        @foreach($company_names as $key => $company_name)
                            <tr>
                                ...
                                <td>
                                    {{ $company_name->contact_no ?? '' }}<br/>{{ $company_name->contact_no2 ?? '' }}
                                </td>
                                <td>
                                    {{ $company_name->email ?? '' }}
                                </td>
                                ...
                                <td>
                                    <a href="{{ url('company_name/' . $company_name->id) }}" class="btn btn-success btn-xs"
