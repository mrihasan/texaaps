...
@section('breadcrumb')
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Show Company</a>
    </li>
@endsection
@push('css')
...
@section('maincontent')
    <div class="card card-success card-tabs">
        ...
        <div class="tab-content">
            <div class="active tab-pane" id="custom-tabs-one-home">
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        <th>Code</th>
                        <td>{{ $company_name->code_name }}</td>
                    </tr>
                    <tr>
                        <th>Contact No (Mobile)</th>
                        <td>{{ $company_name->contact_no }}</td>
                    </tr>
                    <tr>
                        <th>Contact No2 (Phone)</th>
                        <td>{{ $company_name->contact_no2 }}</td>
                    </tr>
                    <tr>
                        <th>Address Line1</th>
                        <td>{{ $company_name->address}}</td>
                    </tr>
                    <tr>
                        <th>Address Line2</th>
                        <td>{{ $company_name->address2}}</td>
                    </tr>
                    <tr>
                        <th>Email Address</th>
                        <td>{{ $company_name->email}}</td>
                    </tr>
                    <tr>
                        <th>Web Address</th>
                        <td>{{ $company_name->web}}</td>
                    </tr>
                    <tr>
                        <th>
                            Status
            ...
            <div class="tab-pane" id="custom-tabs-one-profile">
                <table class="table dataTables table-striped table-bordered table-hover" id="product-table">
                    ...
                    <tbody>
                    @foreach($company_name->products as $key=>$product)
                        <tr>
                            <td>
                                {{ $key+1}}
                            </td>
        ...
        <div class="card-footer">
            ...
            {!! Form::open([
                'method'=>'DELETE',
                'url' => ['company_name', $company_name->id],
            ...
            <a href="{{ url('company_name/' . $company_name->id . '/edit') }}"
