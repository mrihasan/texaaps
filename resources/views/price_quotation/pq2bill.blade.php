                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group row {{ $errors->has('reference') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                {!! Form::text('reference', $price_quotation->ref_no,['class'=>'form-control ', 'placeholder'=>'Enter Reference']) !!}
                    ...
                    <table class="table table-bordered table-hover ">
                        ...
                        @foreach($inventory as $stu)
                            <tr>
                                ...
                                <td><input type="number" name="unitSellPrice[]"
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <input readonly type="number" class="form-control invoiceTotal"
                                       ...
                                       placeholder="Invoice Total" style="text-align:right"
                                       onkeypress="return IsNumeric(event);" ondrop="return false;"
                                       onpaste="return false;" value="<?php echo $price_quotation->invoice_total ?>">
                            </div>
                        </div>
