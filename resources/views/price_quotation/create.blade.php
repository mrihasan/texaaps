...
@section('add_price_quotation','active')
@section('title','Price Quotation Create')
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="{{url('price_quotationTransaction')}}" class="nav-link">{{ __('all_settings.Sales') }}</a>
    </li>
    <li class="nav-item d-none d-sm-inline-block">
...
@section('maincontent')
    ...
    <div class="card card-success card-tabs">
            ...
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-one-home-tab" data-toggle="pill"
                       ...
                       aria-selected="true">Add Price Quotation</a>
                </li>
                <li class="nav-item">
                    <a href="{{ url('price_quotation') }}" class="nav-link">
                        Manage Price Quotation
                    </a>
                </li>
        ...
        <div class="form-body">
            ...
            {!! Form::open(['url' => 'price_quotation', 'files'=> true,'class'=>'form-horizontal','id'=>'saveForm']) !!}
            {{ csrf_field() }}
            <div class="card-body">
                @include ('errors.list')
                        ...
                        <div class="form-group row {{ $errors->has('quotation_date') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12 input-group date" id="quotation_date" data-target-input="nearest">
                                <input type="text" class="form-control datetimepicker-input" name="quotation_date"
                                       value="{{ old('quotation_date') }}" data-target="#quotation_date"/>
                    ...
                    <table class="table table-bordered table-hover ">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="product_details[]"
                                       id="product_details_1" style="text-align:left"
                                       class="form-control"
                                       autocomplete="off"></td>
