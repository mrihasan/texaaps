...
@section('report_expense_type','active')
@section('title','Type Wise Expense Report')
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="{{url('branch')}}" class="nav-link">Report</a>
    </li>
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Type Wise Expense Report</a>
    </li>
@endsection
@push('css')
                    ...
                    <table class="table dataTables table-striped table-bordered table-hover">
                        ...
                        @foreach($expense as $key=>$section)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('typewise_expense_details/'.$section->id) }}" class="btn btn-success btn-xs" title="View "><span class="far fa-eye" aria-hidden="true"/></a>
                                </td>
                    ...
                    <div class="row justify-content-center">
                        <div class="card card-info col-md-8">
                            <div class="card-body">
                                ...
                                {!! Form::open(array('method' => 'get', 'url' => 'typewise_expense_summary','class'=>'form-horizontal')) !!}
