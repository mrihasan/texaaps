...
@section('expense_details','active')
...
@section('breadcrumb')
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Expense Report</a>
    </li>
@endsection
@push('css')
                    ...
                    <div class="row justify-content-center">
                        <div class="card card-info col-md-8">
                            <div class="card-body">
                                ...
                                {!! Form::open(array('method' => 'get', 'url' => 'expense_details_daterange','class'=>'form-horizontal')) !!}
...
//                {extend: 'pdf', title: 'DVL Transaction Data'},
                {
                    ...
                    customize: function (doc) {
                        ...
                        doc.content[1].table.widths = [ '5%', '10%','15%', '10%', '50%', '10%'];
