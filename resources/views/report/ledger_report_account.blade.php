...
@section('title','Ledger Report Account')
@section('breadcrumb')
    <li class="nav-item d-none d-sm-inline-block">
        <a href="{{url('ledger_report_home')}}" class="nav-link">Ledger Report</a>
    </li>
    <li class="nav-item d-none d-sm-inline-block">
        <a href="" class="nav-link">Branch Ledger Report</a>
    </li>
@endsection
@push('css')
        ...
        <div class="card-header p-0 pt-1">
            <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                ...
                <li class="nav-item">
                    ...
                    >{{ __('all_settings.Manage Search') }}</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
                    ...
                    <table class="table dataTables table-striped table-bordered table-hover">
                        ...
                        @foreach($ledger as $key=>$data)
                            <tr>
                                ...
                                <td style="text-align: right">{{($data['transaction_type'][$key]=='Credited'||$data['transaction_type'][$key]=='Receipt'||$data['transaction_type'][$key]=='Sales'||$data['transaction_type'][$key]=='Put Back')?$data['transaction_amount'][$key]:''}}</td>
                                <td style="text-align: right">{{($data['transaction_type'][$key]=='Debited'||$data['transaction_type'][$key]=='Purchase'||$data['transaction_type'][$key]=='Payment'||$data['transaction_type'][$key]=='Return')?$data['transaction_amount'][$key]:''}}</td>
