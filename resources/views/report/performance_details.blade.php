...
@section('performance_details','active')
            ...
            <div class="tab-content" id="custom-tabs-one-tabContent">
                <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel"
                    ...
                    <table class="table dataTables table-striped table-bordered table-hover">
                        <thead style="background-color: #9de0f6">
                        <tr>
                            <th> Serial</th>
                            <th > Date</th>
                            <th> Sl No</th>
                    ...
                    <div class="row justify-content-center">
                        <div class="card card-info col-md-8">
                            <div class="card-body">
                                ...
                                {!! Form::open(array('method' => 'get', 'url' => 'performance_details','class'=>'form-horizontal')) !!}
                                ...
                                <div class="form-group row {{ $errors->has('employee') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6 ">
                                        <select class="form-control show-tick select2bs4 " name="employee" data-live-search="true" required>
                                            <option value="">Select Employee</option>
                                            @foreach($employee as $rep)
                                                <option value="{{$rep->id}}">{{$rep->user_info}}</option>
                                            @endforeach
                                        </select>


                                    @if ($errors->has('employee'))
                                            <span class="help-block"><strong>{{ $errors->first('employee') }}</strong></span>
                                        @endif
                                    </div>
                                </div>
...
//                            doc.content[1].table.body[i][8].alignment = 'left';
                        ...
                        doc.content[1].table.widths = ['10%', '15%', '15%', '35%', '15%', '10%'];
