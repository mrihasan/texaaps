...
@section('manage_expense_approved','active')
...
@section('breadcrumb')
    ...
    <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Manage Approved Expense</a>
    </li>
@endsection
@push('css')
                    ...
                    <table class="table dataTables table-striped table-bordered table-hover">
                        ...
                        @foreach($expense as $key=>$section)
                            <tr>
                                ...
                                <td>
                                    {{--                                    <a href="{{ url('expense/'.$section->id) }}" class="btn btn-success btn-xs" title="View "><span class="far fa-eye" aria-hidden="true"/></a>--}}
                                    @can('ExpenseAccess')
                                        <a href="{{ url('expense/' . $section->id . '/edit') }}"
